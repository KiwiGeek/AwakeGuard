...
set(AWAKEGUARD_FILE_VERSION_STR
    "${AWAKEGUARD_VERSION_MAJOR}.${AWAKEGUARD_VERSION_MINOR}.${AWAKEGUARD_VERSION_PATCH}.${AWAKEGUARD_VERSION_REVISION}-9x-ROFLMAO")
set(AWAKEGUARD_PRODUCT_VERSION_STR
    "${AWAKEGUARD_VERSION_MAJOR}.${AWAKEGUARD_VERSION_MINOR}.${AWAKEGUARD_VERSION_PATCH}-9x-ROFLMAO")
...
get_filename_component(AWAKEGUARD_ASSETS_DIR "${CMAKE_SOURCE_DIR}/../assets" ABSOLUTE)
file(TO_CMAKE_PATH "${AWAKEGUARD_ASSETS_DIR}" AWAKEGUARD_ASSETS_DIR)
string(REPLACE "\\" "/" AWAKEGUARD_ASSETS_DIR "${AWAKEGUARD_ASSETS_DIR}")
...
configure_file(
    "${CMAKE_CURRENT_LIST_DIR}/icons.rc.in"
    "${AWAKEGUARD_GENERATED_DIR}/icons.rc"
    @ONLY)

message(STATUS "AwakeGuard 9x ROFLMAO version: ${AWAKEGUARD_PRODUCT_VERSION_STR}")
