...
void LayoutControls(AppState& app) {
    ...
    y += 30;
    app.chkDisplay = CreateCheck(app.settingsWindow, IDC_CHK_DISPLAY, margin, y, contentWidth, 24, L"Prevent screensaver and display lock");
    y += 42;
    ...
    SetWindowTheme(app.cmbDuration, L"Explorer", nullptr);
